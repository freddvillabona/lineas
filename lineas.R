...
a <- ggplot(UK, 
  ...
  ggtitle("<span style='font-size: 21pt;'> <b> Tuits por minuto (Reino Unido) </b></font>") +
...
b <- ggplot(Total_GLOBAL, 
  ...
  ylab("Cantidad") +
  theme(legend.position="none") +
  ggtitle("<span style='font-size: 21pt;'> <b> Tuits por minuto (Todo el mundo) </b></font>") +
  theme(plot.title = element_markdown(),
